...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/archiviste/onboarding.yaml`
...
4. **Wake-up & règles (Core Archiviste)** : `.openAi-provider/.codex-Archiviste/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent arka-agent00-core-archivist` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/core-archivist/`
- `index` : `ARKA_META/.system/.mem/core-archivist/index.json`
