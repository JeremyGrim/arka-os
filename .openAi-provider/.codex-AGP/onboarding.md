...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/agp/onboarding.yaml`
...
4. **Wake-up & règles (AGP)** : `.openAi-provider/.codex-AGP/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent agp` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
