...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/techarchitect/onboarding.yaml`
...
4. **Wake-up & règles (TechArchitect)** : `.openAi-provider/.codex-TechArchitect/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent technical-architect` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/techarchitect/`
- `index` : `ARKA_META/.system/.mem/techarchitect/index.json`
