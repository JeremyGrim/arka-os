...
4. **Wake-up & règles (EmployeeExperience)** : `.openAi-provider/.codex-EmployeeExperience/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent employee-experience-designer` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
