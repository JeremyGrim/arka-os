...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/contentstrategy/onboarding.yaml`
...
4. **Wake-up & règles (ContentStrategy)** : `.openAi-provider/.codex-ContentStrategy/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent content-strategy-manager` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/contentstrategy/`
- `index` : `ARKA_META/.system/.mem/contentstrategy/index.json`
