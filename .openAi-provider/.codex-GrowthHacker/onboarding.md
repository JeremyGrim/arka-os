...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/growthhacker/onboarding.yaml`
...
4. **Wake-up & règles (GrowthHacker)** : `.openAi-provider/.codex-GrowthHacker/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent growth-hacker-specialist` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/growthhacker/`
- `index` : `ARKA_META/.system/.mem/growthhacker/index.json`
