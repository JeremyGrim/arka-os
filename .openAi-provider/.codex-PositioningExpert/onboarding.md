...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/positioningexpert/onboarding.yaml`
...
4. **Wake-up & règles (PositioningExpert)** : `.openAi-provider/.codex-PositioningExpert/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent positioning-expert` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/positioningexpert/`
- `index` : `ARKA_META/.system/.mem/positioningexpert/index.json`
