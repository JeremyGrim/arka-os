...
4. **Wake-up & règles (MarketResearch)** : `.openAi-provider/.codex-MarketResearch/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent market-research-specialist` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
