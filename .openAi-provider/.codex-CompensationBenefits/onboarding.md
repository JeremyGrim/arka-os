...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/compensationbenefits/onboarding.yaml`
...
4. **Wake-up & règles (CompensationBenefits)** : `.openAi-provider/.codex-CompensationBenefits/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent compensation-benefits-analyst` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/compensationbenefits/`
- `index` : `ARKA_META/.system/.mem/compensationbenefits/index.json`
