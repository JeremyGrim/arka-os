...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/marketinganalytics/onboarding.yaml`
...
4. **Wake-up & règles (MarketingAnalytics)** : `.openAi-provider/.codex-MarketingAnalytics/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent marketing-analytics-expert` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/marketinganalytics/`
- `index` : `ARKA_META/.system/.mem/marketinganalytics/index.json`
