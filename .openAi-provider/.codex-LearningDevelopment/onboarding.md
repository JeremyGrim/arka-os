...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/learningdevelopment/onboarding.yaml`
...
4. **Wake-up & règles (LearningDevelopment)** : `.openAi-provider/.codex-LearningDevelopment/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent learning-development-strategist` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/learningdevelopment/`
- `index` : `ARKA_META/.system/.mem/learningdevelopment/index.json`
