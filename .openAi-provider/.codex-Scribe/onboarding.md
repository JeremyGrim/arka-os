...
- **Messagerie** : exécute `arkamsg pull --agent arka-agent02-core-scribe` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
