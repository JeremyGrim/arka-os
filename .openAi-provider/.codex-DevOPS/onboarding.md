...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/devops/onboarding.yaml`
...
4. **Wake-up & règles (DevOPS)** : `.openAi-provider/.codex-DevOPS/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent devops-guardian` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
