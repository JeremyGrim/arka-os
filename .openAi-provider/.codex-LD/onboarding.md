...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/ld/onboarding.yaml`
...
4. **Wake-up & règles (LD)** : `.openAi-provider/.codex-LD/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent lead-dev-batisseur` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/ld/`
- `index` : `ARKA_META/.system/.mem/ld/index.json`
