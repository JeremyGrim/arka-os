...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/fsx/onboarding.yaml`
...
- **Messagerie** : exécute `arkamsg pull --agent fsx-extreme-fullstack` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
