...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/sw/onboarding.yaml`
...
4. **Wake-up & règles (SW)** : `.openAi-provider/.codex-SW/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent spec-writer` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/sw/`
- `index` : `ARKA_META/.system/.mem/sw/index.json`
