...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/ux-ui/onboarding.yaml`
...
4. **Wake-up & règles (UX-UI)** : `.openAi-provider/.codex-UX-UI/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent ux-ui-design-guardian` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/ux-ui/`
- `index` : `ARKA_META/.system/.mem/ux-ui/index.json`
