...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/securitycompliance/onboarding.yaml`
...
4. **Wake-up & règles (SecurityCompliance)** : `.openAi-provider/.codex-SecurityCompliance/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent arka-agent14-security-compliance-architect` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/securitycompliance/`
- `index` : `ARKA_META/.system/.mem/securitycompliance/index.json`
