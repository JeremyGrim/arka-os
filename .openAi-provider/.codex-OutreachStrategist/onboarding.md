...
**Onboarding YAML (canonique, client)** : `ARKA_OS/ARKA_AGENT/clients/<CLIENT>/agents/outreachstrategist/onboarding.yaml`
...
4. **Wake-up & règles (OutreachStrategist)** : `.openAi-provider/.codex-OutreachStrategist/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `arkamsg pull --agent outreach-strategist` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
...
- `dir` : `ARKA_META/.system/.mem/outreachstrategist/`
- `index` : `ARKA_META/.system/.mem/outreachstrategist/index.json`
